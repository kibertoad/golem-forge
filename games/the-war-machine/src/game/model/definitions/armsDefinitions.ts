...
import { ArmsGrade, type BranchQuality } from '../enums/ArmsStockEnums.ts'
...
export interface ArmsDefinition {
  ...
  grade: ArmsGrade // Technology generation level
