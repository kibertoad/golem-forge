...
import {CommonComponentDefinition} from "../../content/components/CommonComponents.ts";
...
export class CommonComponentModel {
    ...
    constructor(type: ComponentModelTypes, definition: CommonComponentDefinition<any>) {
        ...
        this.durability = new LimitedNumber(definition.maxDurability, definition.maxDurability, false, 'Component durability');
    }
}
