...
import { UIContainer } from '../elements/UIContainer.ts'
import type { AbstractUIElement, AbstractUIElementLite } from '../elements/UIGroup.ts'
...
export class TextBuilder {
  ...
  public setRelativePositionFromBackground(
